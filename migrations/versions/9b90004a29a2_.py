...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["daily_plans_id"],
            ["daily_plans.id"],
            name="fk_daily_plan_has_recipes_daily_plans",
        ),
        sa.ForeignKeyConstraint(
            ["recipes_id"], ["recipes.id"], name="fk_daily_plan_has_recipes_recipes"
        ),
    )
    op.create_index(
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(
        "fk_daily_plan_has_recipes_daily_plans",
        "daily_plan_has_recipes",
        type_="foreignkey",
    )
    op.drop_constraint(
        "fk_daily_plan_has_recipes_recipes",
        "daily_plan_has_recipes",
        type_="foreignkey",
    )
    op.drop_index(
